<div class="bg-white text-black h-[80vh]">
    <div class="shadow-xl">
        <div class="relative pr-6 pl-6">
            <div class="font-bold text-4xl py-5">Choose Trip type</div>
    ...
    <div class="absolute inset-x-0 bottom-0">
        ...
        <div class="relative pr-6 pl-6">
            <div class="font-bold text-xl pb-4">
                <button wire:click="$emit('filterEvent', 'tripType', {{json_encode($selected)}})" class="bg-blue-500 text-white py-2 px-4 text-center rounded-2xl w-full">
                    Apply filters
                </button>
            </div>
        </div>
